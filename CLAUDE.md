...
以下任务动手前先Read [personal-ai-os/SYSTEM.md](personal-ai-os/SYSTEM.md)，按其路由走：备课/课件制作、直播答疑归档、B站视频文稿、知识库归档与巡库、数据分析报告。编码类任务不走这里，照下方委派规则执行。
...
所有决策从问题本质出发，遵循第一性原理，不因「惯例如此」照搬，回到问题本身：
